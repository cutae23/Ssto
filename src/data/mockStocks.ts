...
export const INITIAL_STOCKS: Stock[] = [
  ...
  },
  {
    ...
    rsi: 58,
    ma20: 5210,
    description: '스마트 도어락, 청소 로봇 및 웨어러블 로봇용 정밀 감속 모터 기어를 제조해 삼성전자 등에 메이저 공급하는 수혜주입니다.',
    kneeShoulderIndex: 45,
    kneeShoulderStatus: 'WAIST'
  },
  {
  ...
  },
  {
    ...
    rsi: 52,
    ma20: 3280,
    description: '자율협동 로봇 관절 모듈 및 정밀 제어 액추에이터 원천 기술을 확보한 특수 지능형 기계 로봇 부품 기업입니다.',
  ...
  },
  {
    ...
    rsi: 69,
    ma20: 14800,
    description: '반도체 EDS 테스트 프로브카드용 고기능성 세라믹 다층 기판을 특화 가공해 독과점 공급하는 선도 IT 세라믹 공장입니다.',
  ...
  },
  {
    ...
    low52Week: 6800,
    volume: 240000,
    marketCap: '1조 6,800억원',
    peRatio: 8.5,
    rsi: 48,
    ma20: 8420,
    description: '디젤 발전 가스 엔진, 글로벌 토목 대형 굴착기 및 소형 휠로더 엔진을 공급하는 고성능 산업 인프라 제조 파트너입니다.',
    kneeShoulderIndex: 25,
    kneeShoulderStatus: 'KNEE'
  },
  {
  ...
  },
  {
    ...
    rsi: 44,
    ma20: 7410,
    description: 'LG 계열 대형 종합 광고 기획배급 기업으로서, 글로벌 디지털 및 메타버스 전시 캠페인을 전문 가공 생산 중입니다.',
    kneeShoulderIndex: 36,
    kneeShoulderStatus: 'KNEE'
  },
  {
